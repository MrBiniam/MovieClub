...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Description,Price,Rating")] Movie movie, IFormFile Image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Description,Price,Rating")] Movie movie, IFormFile Image)
        {
            if (id != movie.Id)
            {
                return NotFound();
